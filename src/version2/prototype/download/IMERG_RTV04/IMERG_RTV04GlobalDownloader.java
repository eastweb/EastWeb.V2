 ...
 *
 */
public class IMERG_RTV04GlobalDownloader extends GlobalDownloader {

    public IMERG_RTV04GlobalDownloader(int myID, Config configInstance, String pluginName, DownloadMetaData metaData, ListDatesFiles listDatesFiles, LocalDate startDate) throws ClassNotFoundException,
    ...
    public void run()
    {
        ...
        try {
            ...
            ErrorLog.add(Config.getInstance(), pluginName, metaData.name, "IMERG_RTV04GlobalDownloader.run problem while attempting to download file.", e);
        }
        ...
        for(Map.Entry<DataDate, ArrayList<String>> entry : datesFiles.entrySet())
        {
            ...
            try {
                ...
                for (String f : entry.getValue())
                {
                    ...
                    if (f != null)
                    {
                        IMERG_RTV04Downloader downloader = new IMERG_RTV04Downloader(dd, outFolder, metaData, f);
                        ...
                        try {
                            ...
                            ErrorLog.add(Config.getInstance(), pluginName, metaData.name, "IMERG_RTV04GlobalDownloader.run problem while attempting to add download file.", e);
                        }
                    }
                }
