...
public class ModisLSTV6Factory extends DownloadFactory {
    ...
    public DownloaderFactory CreateDownloaderFactory(ListDatesFiles listDatesFiles) {
        return new ModisLocalStorageDownloadFactory(configInstance, "ModisLSTV6Downloader", projectInfoFile, pluginInfo, downloadMetaData, pluginMetaData, scheduler, outputCache, listDatesFiles, startDate);
    }
    ...
    public ListDatesFiles CreateListDatesFiles() throws IOException {
        return new ModisLSTV6ListDatesFiles(new DataDate(startDate), downloadMetaData, projectInfoFile);
    }
