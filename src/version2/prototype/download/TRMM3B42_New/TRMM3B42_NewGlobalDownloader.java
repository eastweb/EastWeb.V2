...
public class TRMM3B42_NewGlobalDownloader extends GlobalDownloader {
    ...
    public TRMM3B42_NewGlobalDownloader(int myID, Config configInstance, String pluginName, DownloadMetaData metaData, ListDatesFiles listDatesFiles, LocalDate startDate) throws ClassNotFoundException,
