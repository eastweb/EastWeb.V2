 ...
 *
 */
public class ModisNBARQCGlobalDownloader_V6 extends GlobalDownloader
{

    public ModisNBARQCGlobalDownloader_V6(int myID, Config configInstance, String pluginName, DownloadMetaData metaData, ListDatesFiles listDatesFiles, LocalDate startDate) throws ClassNotFoundException, ParserConfigurationException, SAXException,
