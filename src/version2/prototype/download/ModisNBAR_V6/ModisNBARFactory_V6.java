 ...
 *
 */
public class ModisNBARFactory_V6 extends DownloadFactory {

    public ModisNBARFactory_V6(Config configInstance, ProjectInfoFile projectInfoFile, ProjectInfoPlugin pluginInfo, DownloadMetaData downloadMetaData, PluginMetaData pluginMetaData,
    ...
    public ListDatesFiles CreateListDatesFiles() throws IOException {
        return new ModisNBARListDatesFiles_V6 (new DataDate(startDate), downloadMetaData, projectInfoFile );
    }
