...
public class ModisNBARFilterMozaic_V6 extends Mozaic {
    private File[] qcFiles;
    private String qcLevel;
    private Integer noDataValue;

    public ModisNBARFilterMozaic_V6(ProcessData data, Boolean deleteInputDirectory) throws InterruptedException {
